...
import AbstractSelectScheduleCardRangeCommand from "../../../gen/card/commands/AbstractSelectScheduleCardRangeCommand";
...
export default class SelectScheduleCardRangeCommand extends AbstractSelectScheduleCardRangeCommand {
    execute(data) {
        if (data.selectedCardIds.length === 0) {
            ...
            const indexOfSelection = data.cardList.findIndex(card => card.cardId === data.cardId);
            ...
            for (let i = start; i <= end; i++) {
                const cardId = data.cardList[i].cardId
