...
export function loadCards(callback) {
    new LoadCardsAction(callback).apply({});
}

export function createCard(callback) {
    new CreateCardAction(callback).apply({});
}

export function updateCard(callback) {
    new UpdateCardAction(callback).apply({});
}

export function updateCardPriority(cardId, priority, callback) {
    new UpdateCardPriorityAction(callback).apply({cardId, priority});
}

export function deleteCard(callback) {
    new DeleteCardAction(callback).apply({});
}
...
export function moveCards(callback) {
    new MoveCardsAction(callback).apply({});
}

export function changeCardOrder(callback) {
    new ChangeCardOrderAction(callback).apply({});
}
...
export function searchDuplicateCards(callback) {
    new SearchDuplicateCardsAction(callback).apply({});
}
