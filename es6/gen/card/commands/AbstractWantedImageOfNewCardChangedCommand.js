	...
	export default class AbstractWantedImageOfNewCardChangedCommand extends SynchronousCommand {
	    constructor() {
	        super("card.WantedImageOfNewCardChangedCommand");
	    }
		...
		publishEvents(data) {
			...
			if (data.outcomes.includes("ok")) {
				events.push(new Event('card.WantedImageOfNewCardChangedOkEvent'));
