	...
	export default class AbstractGivenImageOfNewCardChangedCommand extends SynchronousCommand {
	    constructor() {
	        super("card.GivenImageOfNewCardChangedCommand");
	    }
		...
		publishEvents(data) {
			...
			if (data.outcomes.includes("ok")) {
				events.push(new Event('card.GivenImageOfNewCardChangedOkEvent'));
