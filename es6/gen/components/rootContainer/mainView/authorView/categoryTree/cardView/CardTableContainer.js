...
export const CardTableContainer = ( props ) => {
	...
	return <CardTable {...props} filterCards={filterCards} >
		<HeaderContainer {...props.header }  filter={props.filter} selectedCategory={props.selectedCategory} selectedCardIds={props.selectedCardIds} cardList={props.cardList}  filterCards={filterCards}  />
