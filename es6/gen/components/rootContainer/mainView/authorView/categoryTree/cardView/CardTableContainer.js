...
export const CardTableContainer = ( props ) => {
	...
	return <CardTable {...props} toggleInputOrder={toggleInputOrder} filterCards={filterCards} toggleAllScheduleCardSelection={toggleAllScheduleCardSelection} scheduleSelectedCards={scheduleSelectedCards} sortSelectedCardsOut={sortSelectedCardsOut} deleteCardClick={deleteCardClick} moveCards={moveCards} >
