...
export const CardTableContainer = ( props ) => {
	...
	return <CardTable {...props} toggleInputOrder={toggleInputOrder} filterCards={filterCards} toggleAllScheduleCardSelection={toggleAllScheduleCardSelection} scheduleSelectedCards={scheduleSelectedCards} sortSelectedCardsOut={sortSelectedCardsOut} >
		...
		<NewCardContainer {...props.newCard }  naturalInputOrder={props.naturalInputOrder} rootCategory={props.rootCategory}  cancelNewCard={cancelNewCard} createCard={createCard} givenOfNewCardChanged={givenOfNewCardChanged} passValueToDictionary={passValueToDictionary} translate={translate} wantedOfNewCardChanged={wantedOfNewCardChanged}  />
		{ props.cardDuplicates ? props.cardDuplicates.map((item, index) => <CardDuplicatesItemContainer {...item} key={item.cardId} index={index} naturalInputOrder={props.naturalInputOrder} rootCategory={props.rootCategory}   routeToSelectedCategory={routeToSelectedCategory}  />) : [] }
	</CardTable> 
}
