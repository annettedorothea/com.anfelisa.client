	...
	export default class AbstractMoveCategoryAllowedCommand extends SynchronousCommand {
	    constructor() {
	        super("category.MoveCategoryAllowedCommand");
	    }
		...
		publishEvents(data) {
			...
			if (data.outcomes.includes("ok")) {
				events.push(new Event('category.MoveCategoryAllowedOkEvent'));
			}
