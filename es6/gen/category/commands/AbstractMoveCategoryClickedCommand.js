	...
	export default class AbstractMoveCategoryClickedCommand extends SynchronousCommand {
	    constructor() {
	        super("category.MoveCategoryClickedCommand");
	    }
		...
		publishEvents(data) {
			...
			if (data.outcomes.includes("ok")) {
				events.push(new Event('category.MoveCategoryClickedOkEvent'));
			}
