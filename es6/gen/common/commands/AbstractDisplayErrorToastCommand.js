	...
	export default class AbstractDisplayErrorToastCommand extends SynchronousCommand {
	    constructor() {
	        super("common.DisplayErrorToastCommand");
	    }
		...
		publishEvents(data) {
			...
			if (data.outcomes.includes("ok")) {
				events.push(new Event('common.DisplayErrorToastOkEvent'));
