...
describe("boxscenarios.WantedLanguageChanged", function () {
	...
	it("dictionaryLookup", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.dictionaryLookup, "dictionaryLookup").toEqual(true)
	});
	it("dictionaryLookupInvalid", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.dictionaryLookupInvalid, "dictionaryLookupInvalid").toEqual(false)
	});
	it("givenLanguage", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.givenLanguage, "givenLanguage").toEqual(`de`)
	});
	it("wantedLanguage", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.wantedLanguage, "wantedLanguage").toEqual(`en`)
	});
