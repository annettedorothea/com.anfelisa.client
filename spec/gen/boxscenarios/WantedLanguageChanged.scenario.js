...
describe("boxscenarios.WantedLanguageChanged", function () {
	...
	it("dictionaryLookupInvalid", async () => {
		expect(appState.rootContainer.mainView.boxSettings.dictionaryLookupInvalid, "dictionaryLookupInvalid").toEqual(false)
	});
	...
	it("wantedLanguage", async () => {
		expect(appState.rootContainer.mainView.boxSettings.wantedLanguage, "wantedLanguage").toEqual(`en`)
	});
