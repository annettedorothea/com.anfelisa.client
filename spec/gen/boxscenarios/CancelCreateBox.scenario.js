...
describe("boxscenarios.CancelCreateBox", function () {
	...
	it("boxList", async () => {
		expect(appState.rootContainer.mainView.dashboardView.boxList, "boxList").toEqual([
		]
		)
	});
	it("deleteBox", async () => {
		expect(appState.rootContainer.mainView.dashboardView.deleteBox, "deleteBox").toEqual({ 
			confirmDelete : false,
			boxId : null
		}
		)
