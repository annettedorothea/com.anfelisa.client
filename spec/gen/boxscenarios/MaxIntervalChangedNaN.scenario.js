...
const Verifications = require("../../src/boxscenarios/MaxIntervalChangedNaNVerifications");
...
describe("boxscenarios.MaxIntervalChangedNaN", function () {
	...
	it("maxInterval", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxInterval, "maxInterval").toEqual(`NaN`)
	});
	it("maxIntervalInvalid", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxIntervalInvalid, "maxIntervalInvalid").toEqual(true)
	});
