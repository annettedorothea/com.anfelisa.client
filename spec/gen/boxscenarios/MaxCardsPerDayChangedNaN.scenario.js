...
describe("boxscenarios.MaxCardsPerDayChangedNaN", function () {
	...
	it("maxCardsPerDay", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxCardsPerDay, "maxCardsPerDay").toEqual(`xxx`)
	});
	it("maxCardsPerDayInvalid", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxCardsPerDayInvalid, "maxCardsPerDayInvalid").toEqual(true)
	});
