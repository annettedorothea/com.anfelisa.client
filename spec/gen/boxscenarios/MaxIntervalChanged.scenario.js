...
describe("boxscenarios.MaxIntervalChanged", function () {
	...
	it("maxInterval", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxInterval, "maxInterval").toEqual(`30`)
	});
	it("maxIntervalInvalid", async () => {
		expect(appState.rootContainer.mainView.boxSettingsView.boxSettings.maxIntervalInvalid, "maxIntervalInvalid").toEqual(false)
	});
