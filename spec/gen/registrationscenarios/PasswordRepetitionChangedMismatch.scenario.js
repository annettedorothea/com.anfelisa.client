...
describe("registrationscenarios.PasswordRepetitionChangedMismatch", function () {
	...
	it("password", async () => {
		expect(appState.rootContainer.mainView.registrationView.password, "password").toEqual(`cd0acfe085eeb0f874391fb9b8009bed`)
	});
	it("passwordRepetition", async () => {
		expect(appState.rootContainer.mainView.registrationView.passwordRepetition, "passwordRepetition").toEqual(`5f4dcc3b5aa765d61d8327deb882cf99`)
	});
	it("passwordMismatch", async () => {
		expect(appState.rootContainer.mainView.registrationView.passwordMismatch, "passwordMismatch").toEqual(true)
	});
