...
describe("registrationscenarios.PasswordRepetitionChanged", function () {
	...
	it("passwordRepetition", async () => {
		expect(appState.rootContainer.mainView.registrationView.passwordRepetition, "passwordRepetition").toEqual(`cd0acfe085eeb0f874391fb9b8009bed`)
	});
	it("passwordMatch", async () => {
		expect(appState.rootContainer.mainView.registrationView.passwordMismatch, "passwordMatch").toEqual(false)
	});
