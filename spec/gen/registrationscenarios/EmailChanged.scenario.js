...
describe("registrationscenarios.EmailChanged", function () {
	...
	it("email", async () => {
		expect(appState.rootContainer.mainView.registrationView.email, "email").toEqual(`info@anfelisa.de`)
	});
	it("emailValid", async () => {
		expect(appState.rootContainer.mainView.registrationView.emailInvalid, "emailValid").toEqual(false)
	});
