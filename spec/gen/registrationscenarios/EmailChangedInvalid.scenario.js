...
describe("registrationscenarios.EmailChangedInvalid", function () {
	...
	it("email", async () => {
		expect(appState.rootContainer.mainView.registrationView.email, "email").toEqual(`email`)
	});
	it("emailInvalid", async () => {
		expect(appState.rootContainer.mainView.registrationView.emailInvalid, "emailInvalid").toEqual(true)
	});
