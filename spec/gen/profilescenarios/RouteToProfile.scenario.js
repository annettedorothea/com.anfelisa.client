...
describe("profilescenarios.RouteToProfile", function () {
	...
	it("username", async () => {
		expect(appState.rootContainer.mainView.profileView.username, "username").toEqual(`username-${testId}`)
	});
	it("email", async () => {
		expect(appState.rootContainer.mainView.profileView.email, "email").toEqual(`info@anfelisa.de`)
	});
